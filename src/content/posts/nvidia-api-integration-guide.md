---
title: Nvidia API 接入与 OpenClaw 集成指南
pubDate: 2026-03-26
categories: ['笔记']
description: '记录 Nvidia 免费 API 接入 OpenClaw 的完整流程：从 API Key 申请到模型配置，支持 Kimi K2.5、Qwen3.5、GLM-5 及 Llama 3.3 等主流开源模型。'
slug: nvidia-api-integration-guide
---

# Nvidia API 接入与 OpenClaw 集成指南
